...
class AmortizationScheduleSimpleTest {
    ...
    void testMonthlyAmortization() {
        ...
        // 2. 创建 service
        ContractService contractService = new ContractServiceImpl(contractRepository, contractUpdateUtil);
        ...
        assertEquals(new BigDecimal("10000.00"), firstItem.getAmortizationAmount(), "每月摊销金额应为10000");
    ...
    void testQuarterlyAmortization() {
        ...
        assertEquals(new BigDecimal("10000.00"), response.getAmortizationSchedule().get(0).getAmortizationAmount());
